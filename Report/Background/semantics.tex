...
\inference[ESWhileT]{\judge{c, \sigma}{true} & \judge{b, \sigma}{\sigma''} & \judge{\mathbf{while} \; c \; \mathbf{invariant} \; i \; \{ \; b \; \}, \sigma''}{\sigma'}}
{\judge{\mathbf{while} \; c \; \mathbf{invariant} \; i \; \{ \; b \; \}, \sigma}{\sigma'}}

\inference[ESWhileF]{\judge{c, \sigma}{false}}
{\judge{\mathbf{while} \; c \; \mathbf{invariant} \; i \; \{ \; b \; \}, \sigma}{\sigma}}

\inference[ESWhile\_ErrC]{\judge{c, \sigma}{\bot}}
{\judge{\mathbf{while} \; c \; \mathbf{invariant} \; i \; \{ \; b \; \}, \sigma}{\bot}}

\inference[ESWhile\_ErrB]{\judge{c, \sigma}{true} & \judge{b, \sigma}{\bot}}
{\judge{\mathbf{while} \; c \; \mathbf{invariant} \; i \; \{ \; b \; \}, \sigma}{\bot}}
